...
import pandas as pd
import numpy as np
from helper import list_of_selected_locations_kolkata, locations_list_kolkata
from decomp import get_files


@st.cache_resource
def load_pred():
    model = get_files("Kolkata")
    return model
...
st.markdown(
    """
This app predicts the **Kolkata House Price**!
"""
)
...
def user_input_features():
    ...
    for i in list_of_selected_locations_kolkata:
