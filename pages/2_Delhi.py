...
import pandas as pd
import numpy as np
from helper import list_of_selected_locations_delhi, locations_list_delhi
from decomp import get_files


@st.cache_resource
def load_pred():
    model = get_files("Delhi")
    return model
...
st.markdown(
    """
This app predicts the **Delhi House Price**!
"""
)
...
def user_input_features():
    ...
    for i in list_of_selected_locations_delhi:
